...
# random.choice([0,1]) or random.choice([0,2]) for extream left or right in generate_tile_coordinate function
# also increase the probabily of stright lines
# use touch_move function instead of touch_down function
...
class MainWidget(Widget):
    from transforms import transform_perspective, transform_2D, transform
    ...
    def generate_tiles_coordinates(self):
        ...
        if len(self.tiles_coordinates) > 0:
            last_cordinates = self.tiles_coordinates[-1]
